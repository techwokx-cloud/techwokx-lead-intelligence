...
def research_company(company_name: str = "", website: str = "", progress_cb=None) -> CompanyResearchResult:
    ...
    query = f"{company_name}" if company_name else website
    ...
    if result.domain:
        ...
        if result.dns_result and hasattr(result.dns_result, 'email_provider') and result.dns_result.email_provider and result.dns_result.email_provider != "None":
